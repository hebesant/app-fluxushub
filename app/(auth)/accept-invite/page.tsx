...
import { AcceptInviteCard } from "@/features/auth/components/AcceptInviteCard";
...
export default function AcceptInvitePage() {
  return (
    <main className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-neutral-950 px-4 py-10 text-white light:bg-slate-50 light:text-slate-950">
      ...
      <Suspense fallback={<p className="text-sm text-neutral-300 light:text-slate-500">Carregando convite...</p>}>
        <AcceptInviteCard />
      </Suspense>
    </main>
  );
